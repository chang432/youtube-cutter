...
const MemberBadge = ({ isPremium }) => {
    return (
        <div className="fixed top-3 right-4">
            <div className="bg-stone-100 rounded-full pl-2 pr-6 py-2 flex flex-row items-center justify-between space-x-4 border border-black">
                <img
