...
const PremiumDialog = ({ setShowPremiumDialog }) => {
    ...
    return (
        <div>
            ...
            <div className="fixed inset-1/2 w-2/3 h-5/6 transfrom -translate-x-1/2 -translate-y-1/2 z-[9999] border border-black bg-white flex flex-col justify-center items-center py-6 px-20 text-center leading-tight text-lg">
                <div className="mb-8 flex flex-row">
                    <p>
                        <span className="text-red-600">Help us pay for server costs</span>
                        {" with a monthly subscription of any amount!"}
                    </p>
                </div>
                ...
                <div className="text-left mb-10">
                    <p>1. On our <span className="hover:cursor-pointer text-red-600 font-bold underline" onClick={handleKofiTextClicked}>Ko-fi page</span>, sign up for a monthly donation with any amount of your choice.</p>
